...
#: We expected input of [4, 1, 2, 3] to return True when it returns False

# - What error message (if any) is there?
#: There is no error message

# - What line number is causing the error?
#:  Line 32 where the else statement was

# - What can you deduce about the cause of the error?
#: We can say that with an if else statement either one or the other must get executed 

# PART 2: State Assumptions
#
# TODO: State your assumptions here or say them out loud to your partner ...
# Make sure to be SPECIFIC about what each of your assumptions is!
#: We are assuming that the loop with continue for all the values in the array but it is not.
