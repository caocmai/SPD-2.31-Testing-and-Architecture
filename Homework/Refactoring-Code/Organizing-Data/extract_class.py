...
class FoodDish:
    ...
    def __init__(self, name, prep_time, is_veggi, food_type, food_origin, ingredients, instructions):
        self.name = name
        self.prep_time = prep_time
        self.is_veggi = is_veggi
...
foodList = [FoodDish("butter squash soup", 45, True, "soup", "North African",  ['butter squash','onion','carrot', 'garlic','butter','black pepper', 'cinnamon','coconut milk'], '1. Grill the butter squash, onion, carrot and garlic in the oven until'
          ...
          'butter and coconut milk. Blend them till they become puree. Then move the content into a pot'
            ...
            FoodDish("shirazi salad", 5, True, "salad", "Iranian", ['cucumber', 'tomato', 'onion', 'lemon juice'], '1. dice cucumbers, tomatoes and onions 2. put all into a bowl 3. pour lemon juice 3. add salt'
                '4. Mixed them thoroughly'),
            
            FoodDish("Home-made Beef Sausage", 60, False, "deli", "All", ['sausage casing','regular ground beef','garlic', 'corriander seeds','black pepper seeds','fennel seed','paprika'], '1. In a blender,'
...
for dish in foodList:
    ...
    print("Prep time:",dish.prep_time, "mins")
    print("Is Veggie?", 'Yes' if dish.is_veggi else "No")
    print("Food Type:", dish.food_type)
    print("Cuisine:", dish.food_origin)
    for item in dish.ingredients:
        print(item, end=', ')
    print()
    print("recipe", dish.instructions)
    print("***")
